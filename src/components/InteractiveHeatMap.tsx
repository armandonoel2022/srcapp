...
// Datos completos del mapa de calor del Distrito Nacional - Coordenadas corregidas
const heatMapZones = [
  // Zonas Rojas (Calientes) - Alto riesgo
  { name: "24 de Abril", type: "hot", color: "red", coords: [18.4756, -69.9334], population: 53870 },
  { name: "Cristo Rey", type: "hot", color: "red", coords: [18.4589, -69.9156], population: 257038 },
  { name: "Domingo Savio", type: "hot", color: "red", coords: [18.4745, -69.9467], population: 184863 },
  { name: "Ensanche Capotillo", type: "hot", color: "red", coords: [18.4912, -69.9256], population: 134708 },
  { name: "Gualey", type: "hot", color: "red", coords: [18.4789, -69.9123], population: 91147 },
  { name: "La Zurza", type: "hot", color: "red", coords: [18.4834, -69.9101], population: 42896 },
  { name: "Los Jardines", type: "hot", color: "red", coords: [18.4667, -69.9134], population: 97568 },
  { name: "Los Restauradores", type: "hot", color: "red", coords: [18.4623, -69.9223], population: 78945 },
  { name: "Nuevo Arroyo Hondo", type: "hot", color: "red", coords: [18.5012, -69.9145], population: 123501 },
  { name: "Nuestra Señora de la Paz", type: "hot", color: "red", coords: [18.4778, -69.9134], population: 98961 },
  { name: "Palma Real", type: "hot", color: "red", coords: [18.4823, -69.9023], population: 101543 },
  { name: "Simón Bolívar", type: "hot", color: "red", coords: [18.4678, -69.9245], population: 88463 },
  { name: "Villa Consuelo", type: "hot", color: "red", coords: [18.4523, -69.9145], population: 40621 },
  { name: "Villa Francisca", type: "hot", color: "red", coords: [18.4578, -69.9156], population: 50185 },
  { name: "Villa Juana", type: "hot", color: "red", coords: [18.4511, -69.9142], population: 60323 },

  // Zonas Amarillas (Intermedias) - Riesgo moderado  
  { name: "Altos de Arroyo Hondo", type: "intermediate", color: "yellow", coords: [18.4934, -69.9134], population: 19617 },
  { name: "Buenos Aires", type: "intermediate", color: "yellow", coords: [18.4712, -69.9245], population: 25770 },
  { name: "Ensanche Espaillat", type: "intermediate", color: "yellow", coords: [18.4689, -69.9023], population: 16803 },
  { name: "Ensanche La Fe", type: "intermediate", color: "yellow", coords: [18.4756, -69.9012], population: 19094 },
  { name: "Ensanche Luperón", type: "intermediate", color: "yellow", coords: [18.4823, -69.9134], population: 23710 },
  { name: "Ensanche Quisqueya", type: "intermediate", color: "yellow", coords: [18.4689, -69.9223], population: 24850 },
  { name: "Honduras del Norte", type: "intermediate", color: "yellow", coords: [18.4867, -69.9134], population: 9771 },
  { name: "Honduras del Oeste", type: "intermediate", color: "yellow", coords: [18.4823, -69.9145], population: 8884 },
  { name: "Jardines del Sur", type: "intermediate", color: "yellow", coords: [18.4456, -69.9023], population: 8777 },
  { name: "Julieta Morales", type: "intermediate", color: "yellow", coords: [18.4634, -69.9134], population: 14843 },
  { name: "La Agustina", type: "intermediate", color: "yellow", coords: [18.4712, -69.9156], population: 20308 },
  { name: "La Hondonada", type: "intermediate", color: "yellow", coords: [18.4789, -69.9145], population: 14575 },
  { name: "La Isabela", type: "intermediate", color: "yellow", coords: [18.4656, -69.9223], population: 6865 },
  { name: "La Julia", type: "intermediate", color: "yellow", coords: [18.4723, -69.9089], population: 12575 },
  { name: "Las Praderas", type: "intermediate", color: "yellow", coords: [18.4567, -69.9145], population: 29765 },
  { name: "Los Peralejos", type: "intermediate", color: "yellow", coords: [18.4634, -69.9156], population: 35684 },
  { name: "Los Ríos", type: "intermediate", color: "yellow", coords: [18.4789, -69.9134], population: 27563 },
  { name: "María Auxiliadora", type: "intermediate", color: "yellow", coords: [18.4678, -69.9223], population: 20456 },
  { name: "Mata Hambre", type: "intermediate", color: "yellow", coords: [18.4712, -69.9134], population: 20456 },
  { name: "Mejoramiento Social", type: "intermediate", color: "yellow", coords: [18.4823, -69.9156], population: 19753 },
  { name: "Mirador Norte", type: "intermediate", color: "yellow", coords: [18.4934, -69.9023], population: 20465 },
  { name: "Miraflores", type: "intermediate", color: "yellow", coords: [18.4756, -69.9145], population: 76862 },
  { name: "Miramar", type: "intermediate", color: "yellow", coords: [18.4689, -69.9134], population: 59876 },
  { name: "Paseo de los Indios", type: "intermediate", color: "yellow", coords: [18.4634, -69.9023], population: 28951 },
  { name: "Los Próceres", type: "intermediate", color: "yellow", coords: [18.4767, -69.9089], population: 56513 },
  { name: "Renacimiento", type: "intermediate", color: "yellow", coords: [18.4612, -69.9156], population: 20145 },
  { name: "Viejo Arroyo Hondo", type: "intermediate", color: "yellow", coords: [18.4945, -69.9023], population: 38964 },
  { name: "Villas Agrícolas", type: "intermediate", color: "yellow", coords: [18.4723, -69.9134], population: 48621 },

  // Zonas Verdes (Frías) - Bajo riesgo
  { name: "30 de Mayo", type: "cold", color: "green", coords: [18.4612, -69.9134], population: 5904 },
  { name: "Arroyo Manzano", type: "cold", color: "green", coords: [18.4789, -69.9023], population: 5894 },
  { name: "Atala", type: "cold", color: "green", coords: [18.4656, -69.9145], population: 3711 },
  { name: "Bella Vista", type: "cold", color: "green", coords: [18.4712, -69.9023], population: 15593 },
  { name: "El Cacique", type: "cold", color: "green", coords: [18.4634, -69.9089], population: 7671 },
  { name: "Centro de los Héroes", type: "cold", color: "green", coords: [18.4667, -69.8912], population: 62 },
  { name: "Centro Olímpico", type: "cold", color: "green", coords: [18.4689, -69.8923], population: 99 },
  { name: "Cerros de Arroyo Hondo", type: "cold", color: "green", coords: [18.4923, -69.9134], population: 3258 },
  { name: "Ciudad Colonial", type: "cold", color: "green", coords: [18.4739, -69.8826], population: 8472 },
  { name: "Ciudad Nueva", type: "cold", color: "green", coords: [18.4612, -69.8934], population: 12540 },
  { name: "Ciudad Universitaria", type: "cold", color: "green", coords: [18.4623, -69.8934], population: 8016 },
  { name: "El Millón", type: "cold", color: "green", coords: [18.4789, -69.9145], population: 9137 },
  ...
  { name: "General Antonio Duverge", type: "cold", color: "green", coords: [18.4634, -69.9145], population: 4382 },
  { name: "Jardín Botánico", type: "cold", color: "green", coords: [18.4712, -69.9134], population: 271 },
  { name: "Jardín Zoológico", type: "cold", color: "green", coords: [18.4723, -69.9023], population: 19 },
  { name: "La Castellana", type: "cold", color: "green", coords: [18.4678, -69.9134], population: 10421 },
  { name: "La Esperilla", type: "cold", color: "green", coords: [18.4634, -69.9023], population: 6807 },
  { name: "Los Cacicazgos", type: "cold", color: "green", coords: [18.4756, -69.9012], population: 15725 },
  { name: "Los Prados", type: "cold", color: "green", coords: [18.4789, -69.9089], population: 20457 },
  { name: "Mirador Sur", type: "cold", color: "green", coords: [18.4467, -69.9134], population: 20211 },
  { name: "Paraíso", type: "cold", color: "green", coords: [18.4756, -69.9145], population: 75862 },
  { name: "Piantini", type: "cold", color: "green", coords: [18.4823, -69.9034], population: 59753 },
  { name: "San Carlos", type: "cold", color: "green", coords: [18.4689, -69.9023], population: 13456 },
  { name: "San Diego", type: "cold", color: "green", coords: [18.4634, -69.9134], population: 9864 },
  { name: "San Geronimo", type: "cold", color: "green", coords: [18.4712, -69.9145], population: 8634 },
  { name: "San Juan Bosco", type: "cold", color: "green", coords: [18.4756, -69.9023], population: 14352 }
];
